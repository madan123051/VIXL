...
export function Hero() {
  ...
  return (
    <section className="relative h-[100svh] min-h-[560px] w-full">
      ...
      <motion.div
        className="absolute inset-x-0 bottom-0 z-10 mx-auto flex max-w-[1600px] flex-col gap-5 overflow-visible px-4 pb-12 md:px-6 md:pb-16"
      ...
      >
        ...
        <motion.h1
          ...
          className="font-display max-w-4xl overflow-visible text-4xl leading-[1.28] font-semibold tracking-[-0.03em] text-fg sm:text-5xl md:text-7xl"
        >
          {line1}
          {line2 ? (
            <>
